...
disturb_uncertainty_rates=(0.0 0.2 0.5 1.0)
    ...
    do
        ...
        do
            ...
            do
                ...
                # python train.py --use_wandb --program $program --export_mode --mass_uncertainty_rate $mm --disturb_uncertainty_rate $dd --disturb_period $pp --seed $ss
